  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    else
    {
		...
		{	
			...
			send.sendMail("contato.clinicalab@gmail.com", email, "Redefinir Senha - Clinica Lab", ("Ola para redefinir sua senha acesse o link: http://localhost:8080/LabWeb/RedefinirSenhaServlet?email="+email));
