...
<body>
	...
	<div style="display:none;" id="dialog-confirm" title="Excluir Dúvida">
  			<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Tem certeza que deseja excluir essa Dúvida?</p>
	</div>
