 ...
 <script>
  function deletagem(x){
	  $( "#dialog-confirm" ).dialog({
	      ...
	      buttons: {
	        "Excluir": function() {
	         window.location.href = "DeletarPacienteServlet?paciente="+x;	         
	        },
	        Cancel: function() {
	          $( this ).dialog( "close" );
	        }
...
<body>
	...
	<div id="pagina">
						...
						<tbody>
							<c:forEach var="paciente" items="${pacientes}">
								...
								<tr>
									...
									<td>
									<button class="but" style="width: 50px; height: 20px;" id="deletar" onclick="deletagem(${paciente.id})"></button>
									</td>
								</tr>
		...
		<div style="display:none;" id="dialog-confirm" title="Excluir Paciente">
  				<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Tem certeza que deseja excluir o paciente? ${paciente.nome_paciente} Lembrando que caso exclua o paciente selecionado, todos os dados relacionados a ele também serão perdidos.</p>
				</div>
