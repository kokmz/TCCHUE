...
--
-- Host: 127.0.0.1
-- Generation Time: 15-Maio-2015 às 05:40
...
ALTER TABLE `paciente`
 ADD PRIMARY KEY (`id_paciente`), ADD UNIQUE KEY `cod_verif` (`cod_verif`), ADD UNIQUE KEY `rg_paciente` (`rg_paciente`), ADD UNIQUE KEY `rg_paciente_2` (`rg_paciente`), ADD UNIQUE KEY `rg_paciente_3` (`rg_paciente`), ADD UNIQUE KEY `rg_paciente_4` (`rg_paciente`), ADD KEY `id_logradouro` (`id_logradouro`), ADD KEY `fk_estado` (`id_estado`);
