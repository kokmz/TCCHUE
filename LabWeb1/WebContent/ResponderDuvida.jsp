...
<h1>Responda a dúvida</h1>
	...
	<form id="duvida" action="ResponderServlet" method="post">
			...
			<p><label for="email">Email:</label><input id="email" type="text" name="email" value="${empty duvida ? param.email : duvida.email}" disabled/></p>
			<p><label>Duvida: </label> <label for="mensagem">${duvida.mensagem }</label></p>
