...
<div id="formulario">
 ...
 <c:if test="${loginUsuario.perfil.gestor && loginUsuario.perfil.administrador}">  
 <p>
	...
	<form id="paciente" action="PacienteServlet" method="post">
			...
			<p><label for="cod_verif">Código de Verificação</label><br/> <input type="text" name="cod_verif" value="${empty paciente ? param.cod_verif : paciente.cod_verif }"/></p>
			
			<p><label for="nome">Nome</label> <br /> <input type="text"	name="nome_paciente" value="${empty paciente ? param.nome_paciente : paciente.nome_paciente}"/></p>
			<p><label for="rg">RG</label> <br /> <input type="text" name="rg_paciente" value="${empty paciente ? param.rg_paciente : paciente.rg_paciente}"/></p>			
			...
			<p><label for="numero">Número</label><br/> <input type="text" name="endereco_num" value="${empty paciente ? param.endereco_num : paciente.endereco_num }"/></p>
			...
			<p><label for="convenio">Convênio</label><br/> <input type="text" name="convenio_paciente" value="${empty paciente ? param.convenio_paciente : paciente.convenio_paciente }"/></p>
	...
	<input name="gerarcodigo" type="button" onclick="GerarCodigoServlet" value="Gerar Código">
</c:if>
</div>
</div>
</div>