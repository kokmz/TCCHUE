				...
				<form class="cadastro-gestor" id="paciente" action="PacienteServlet" method="post" style="height:0px;">
					...
					<div class="form-wrapper">
						<input class="formgestor" id="cpf"
							...
							value="${empty paciente ? param.cpf_paciente : paciente.cpf_paciente }" name="cpf" placeholder="CPF" /><label class="formgestor" for="cpf">CPF</label><span class="cpfInvalido" style="display: none;">CPF Inválido.</span>
					</div>		
