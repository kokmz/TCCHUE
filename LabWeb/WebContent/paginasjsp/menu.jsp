...
<ul>
   		<c:if test="${loginUsuario.perfil.gestor}">
			<li class='active'><a href='index.jsp'><span>Inicio</span></a></li>
   			...
   			<li><a href='#'><span>Cadastro</span></a>
   				<ul>
   					...
   					<li><a href='ListaExameServlet'><span>Resultado do Exame</span></a></li>
   				</ul>
   			</li>
			...
			<li class='last'><a href='#'><span>Relatório</span></a>
				<ul>
					...
					<li><a href='ListaPacienteProntuarioServlet'><span>Prontuário Digital</span></a></li>
					<li><a href='ListaPacienteHistoricoServlet'><span>Histórico de Exames</span></a></li>
				</ul>
			</li>
		</c:if>
		...
		<c:if test="${loginUsuario.perfil.admin}">
			<li class='active'><a href='index.jsp'><span>Inicio</span></a></li>
   			...
   			<li><a href='#'><span>Cadastro</span></a>
   				<ul>
   					<li><a href='ListaGestorServlet'><span>Usuário</span></a></li>
   					<li><a href='ListaPacienteServlet'><span>Paciente</span></a></li>
   					<li><a href='ListaExameServlet'><span>Resultado do Exame</span></a></li>
   				</ul>
   			</li>
