...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1" import="site.vo.*" import="java.sql.* " import="site.dao.*"
...
<script>
	...
	var cep = document.getElementById("cep").value;
		...
		String sql = "SELECT endereco, bairro FROM logradouro WHERE cep="+cep;
	...
	document.cadPaciente.endereco_bairro.value += logradouro.bairro;
	document.cadPaciente.endereco.value += logradouro.endereco;
	}
</script>
...
<div id="formulario">
 ...
 <p>
	...
	<form name="cadPaciente" id="paciente" action="PacienteServlet" method="post">
			...
			<p><label id="cep_p" for="cep">CEP:</label><input onchange="PreencheCampos()" id="cep" type="text" name="cep" value="${empty paciente ? param.logradouro.cep : paciente.logradouro.cep }"/>
