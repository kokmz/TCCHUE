...
<div style="display:none;" id="dialog-confirm" title="Excluir Resultado de Exame">
  			<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Tem certeza que deseja excluir o Resultado do Exame? Lembrando que caso exclua todos os dados serão perdidos permanentemente</p>
	</div>
