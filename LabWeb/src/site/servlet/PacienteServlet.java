...
public class PacienteServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {    
			...
			String cidade_paciente = request.getParameter("cidade_paciente");
			...
			String convenio_paciente = request.getParameter("convenio_paciente");
				...
				if (cod_verif != null || nome_paciente != null && !nome_paciente.isEmpty() || rg_paciente != null && !rg_paciente.isEmpty() || cpf_paciente != null && !cpf_paciente.isEmpty() || datanasc_paciente != null && !datanasc_paciente.isEmpty() || cidade_paciente != null && !cidade_paciente.isEmpty() || endereco_num != null || estado != null || cep != null || telefone_paciente !=null && !telefone_paciente.isEmpty() || email_paciente !=null && !email_paciente.isEmpty() || convenio_paciente !=null && !convenio_paciente.isEmpty())
				{
					request.setAttribute("mensagemErro", "campos vazios!");
					getServletContext().getRequestDispatcher("/TelaPacienteServlet.jsp").forward(request, response);          
				}
				else
				{
