	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {    
			...
			String convenio_paciente = request.getParameter("convenio_paciente");
				...
				if (cod_verif == 0|| nome_paciente.isEmpty() || rg_paciente.isEmpty() || cpf_paciente.isEmpty() || datanasc_paciente.isEmpty() || cidade_paciente.isEmpty() || endereco_num == 0 || endereco_complemento.isEmpty() ||estado == 0 || cep == 0 || telefone_paciente.isEmpty() || email_paciente.isEmpty() || convenio_paciente.isEmpty())
				{
