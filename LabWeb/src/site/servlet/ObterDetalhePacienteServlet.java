...
/**
 * Servlet implementation class ObterDetalhePacienteServlet
 */
@WebServlet("/ObterDetalhePacienteServlet")
public class ObterDetalhePacienteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public ObterDetalhePacienteServlet() {
        super();
    }
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			getServletContext().getRequestDispatcher( "/montaDetalhePaciente.jsp").forward(request, response);
		}
	}
}
