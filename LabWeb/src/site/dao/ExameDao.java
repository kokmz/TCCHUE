...
public List<Exame> getResultado(int cod_verif)
	{
		...
		try
		{
			...
			String sql = "SELECT exame.id_exame, exame.id_paciente, exame.id_tabelaExame, DATE_FORMAT(exame.data_exame, '%d/%m/%Y') data_exame, tabela_exame.exame_nome, status_exame.status_nome, paciente.nome_paciente "
