...
public class PacienteDao extends Dao {
	...
	public Paciente getPaciente(int idPaciente)
	{
		...
		try
		{
			...
			String sql = "SELECT p.id_paciente, p.cod_verif, p.nome_paciente, p.rg_paciente, p.cpf_paciente, p.datanasc_paciente, p.cidade_endereco, p.numero_endereco, p.complemento_endereco, p.telefone_paciente, p.email_paciente, p.convenio_paciente, l.id_logradouro, l.cep, l.endereco, l.bairro, e.id_estado, e.sigla_estado, e.nome_estado FROM paciente p, logradouro l, estado e WHERE p.id_logradouro = l.id_logradouro AND p.id_estado = e.id_estado AND p.id_paciente=?";        
