...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Out-2014 às 15:05
...
INSERT INTO `exame` (`id_exame`, `id_paciente`, `descricao`) VALUES
(4, 5, 'saudsauhduhasduhasd');
...
--
ALTER TABLE `exame`
 ADD PRIMARY KEY (`id_exame`), ADD KEY `exame_ibfk_1` (`id_paciente`);
...
ALTER TABLE `tabela_exame`
 ADD PRIMARY KEY (`id_tabelaExame`);
