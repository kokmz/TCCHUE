...
<jsp:forward page="index.jsp"/>  
		...
		<form id="exame" action="cadResultadoExameServlet" method="post">
			...
			<p>
				<label for="descricao">Descrição / Resultado Exame:</label>
			</p>
			...
			<p><label id="nome_medico" for="nome_medico">Nome do Médico:</label><input
				type="text" name="nome_medico" value="${empty exame ? param.nome_medico : exame.nome_medico }" />
			</p>
			
			<p><label id="crm_medico" for="crm_medico">CRM do Médico:</label><input
				type="text" name="crm_medico" value="${empty exame ? param.crm_medico : exame.crm_medico }" />
			</p>
