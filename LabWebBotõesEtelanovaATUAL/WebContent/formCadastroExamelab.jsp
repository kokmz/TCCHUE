...
<div id="formulario" class="formcadastro">
	<form id="formcadastroexamelab" action="ExamelabServlet" method="post">
			...
			<div class="form-wrapper">
			<textarea  class="formgestor" rows="5" cols="50" name="procedimento" placeholder="Descrição do procedimento..." ${empty exame ? param.procedimento : exame.procedimento}/>${empty exame ? param.procedimento : exame.procedimento}</textarea><label class="formgestor" for="procedimento">Procedimento</label>
			</div>			
