...
/**
 * Servlet implementation class ObterExamelabServlet
 */
@WebServlet("/ObterExamelabServlet")
public class ObterExamelabServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public ObterExamelabServlet() {
        super();
    }
