...
<div id="conteudo">
		...
		<form id="fluxo" action="" method="post">
			...
			<input type="hidden" value="Gerar Relatório" />
			<a onclick="document.getElementById('fluxo').submit();" href="../PDF/Relatorio.pdf" > Gerar Relatório</a>
		</form>
